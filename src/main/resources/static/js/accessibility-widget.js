...
<style>
  ...
  .uwaw, .reset-panel, .copyrights-accessibility {
  ...
  .uwaw .second-panel h2 {
    color: var(--header-gov-title-hi-ncert) !important;
    font-weight: 600 !important;
  }

  .uwaw .inner-short-key {
    background-color: var(--header-border-color) !important;
    color: var(--header-secondary-text) !important;
  }
  ...
  .uwaw-close:focus {
    ...
    background-color: transparent !important;
    box-shadow: none !important;
    filter: brightness(0) opacity(1) !important; /* Optional: makes the X slightly darker on hover */
  }
  ...
  .uwaw button:not(.uwaw-close):focus,
  .uwaw button:not(.uwaw-close):hover {
      background-color: #f8f9fa !important;
      border-color: var(--header-gov-title-hi-ncert) !important;
  }

  .uwaw-close:hover {
      filter: brightness(0) opacity(1) !important; /* Makes the icon solid black on hover */
      background-color: transparent !important;
  ...
  .uwaw-feature-active .uwaw-features__item__i {
    border-color: var(--header-gov-title-hi-ncert) !important;
    box-shadow: 0 0 0 3px rgba(26, 35, 126, 0.1) !important;
  }
  .ux4g-accessibility-feature-active .ux4g-icon,
  .uwaw-feature-active .ux4g-icon {
    background-color: var(--header-gov-title-hi-ncert) !important;
  }
  .tick-active {
    background-color: var(--header-gov-title-hi-ncert) !important;
  }
  ...
  .uw-widget-custom-trigger {
    background-color: var(--header-gov-title-hi-ncert) !important;
    border: 2px solid var(--header-gov-title-hi-ncert) !important;
  }
</style>
</head>
...
<div id="accessibility-overlay">
    ...
    function saveSettings() {
        ...
        // console.log("âœ… Cookie saved for domain:", cookieDomain || 'current domain');
